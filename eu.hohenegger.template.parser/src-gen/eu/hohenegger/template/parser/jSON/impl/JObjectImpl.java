 ...
 * <ul>
 *   <li>{@link eu.hohenegger.template.parser.jSON.impl.JObjectImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class JObjectImpl extends ValueImpl implements JObject
{
  /**
  ...
  public EList<Entry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<Entry>(Entry.class, this, JSONPackage.JOBJECT__ENTRIES);
    }
    return entries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JSONPackage.JOBJECT__ENTRIES:
